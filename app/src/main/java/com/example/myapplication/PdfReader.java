...
public class PdfReader extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener, OnPageErrorListener {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sh = getSharedPreferences("PdfReader", Context.MODE_PRIVATE);
